  ...
  return (
    <>
      <div className="bg-lightC">
        ...
        <div className="grid grid-cols-2 gap-4 bg-lightC pt-24  pb-8 px-4 gb box-shad relative">
        ...
        <div className="flex relative justify-center  items-center bg-lightC mt-[-10px] box-shad p-4 ">
          <a>
